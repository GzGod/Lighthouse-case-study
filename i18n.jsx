...
const DICT = {
  zh: {
    ...
    "win.compare.eyebrow": "TOP KOL CPM / CPE BENCHMARK",
    "win.compare.title_a": "把灯塔成本放进",
    "win.compare.title_b": "头部 KOL 参照系。",
    "win.compare.desc": "内部样本只能说明谁更高效，但不能说明价格到底贵不贵。这里预留外部头部 KOL 的 CPM / CPE 对照，后续填入真实报价后，用户就能直接看到灯塔投放和单点头部账号投放的成本差异。",
    "win.compare.status": "头部 KOL 参考数据",
    "win.compare.best": "灯塔最低样本",
    "win.compare.best_note": "当前基准池最低 CPM",
    "win.compare.avg": "灯塔加权均值",
    "win.compare.avg_name": "{baselineCount} 个基准样本",
    "win.compare.avg_note": "当前基准池均值",
    "win.compare.lh_cpm": "灯塔 CPM",
    "win.compare.lh_cpe": "灯塔 CPE",
    "win.compare.kol_cpm": "头部 KOL CPM",
    "win.compare.kol_cpe": "头部 KOL CPE",
    "win.compare.lighthouse_note": "{baselineCount} 个基准样本加权计算",
    "win.compare.lighthouse_base": "灯塔基准",
    "win.compare.placeholder_short": "头部 KOL 参考数据",
    "win.compare.placeholder": "外部头部 KOL CPM / CPE 参考",
    "win.compare.vs": "相对灯塔最低",
    "win.compare.multiple": "{multiple}x 相对灯塔最低",
    "win.compare.metric_cpm": "CPM",
    "win.compare.metric_cpe": "CPE",
    "win.compare.kol1.label": "头部 KOL 例 01",
    "win.compare.kol1.name": "头部中文 KOL（待填）",
    "win.compare.kol2.label": "头部 KOL 例 02",
    "win.compare.kol2.name": "头部英文 KOL（待填）",
    "win.compare.kol3.label": "头部 KOL 例 03",
    "win.compare.kol3.name": "垂直赛道 KOL（待填）",
    ...
    "stars.sample": "SAMPLE",
    "stars.s1.tag": "综合效率样本", "stars.s1.en": "BEST OVERALL · COST × ENGAGEMENT",
    "stars.s1.story": "{starName} 在当前样本里跑出了更突出的综合效率：预算 {starBudget} USDC、曝光 {starImp}、CPE {starCpe}。这个位置会优先选择没有被其他样本占用、同时互动成本更低的项目。",
    ...
    "stars.s2.story": "{starName} 是当前基准池里单场曝光最高的样本，交付了 {starImp} 次曝光。这个位置会优先锁定最大声量样本，避免它同时占用其他玩法位。",
    "stars.s2.take": "当目标是先把市场看见做出来，最大曝光样本能给后续预算、KOL 层级和内容密度提供直接参照。",
    "stars.s3.tag": "讨论深度最强", "stars.s3.en": "DEEPEST CONVERSATION",
    "stars.s3.story": "{starName} 在未被占用的样本里互动率最高，达到 {starEr}%。这里代表的不是单纯买曝光，而是内容、受众和话题真正接上的讨论深度。",
    "stars.s3.take": "当需求更看重讨论质量，就不能只买大号曝光。更重要的是理解内容节奏、人群情绪和议题推进方式。",
    "stars.s4.tag": "低预算曝光样本", "stars.s4.en": "LOW-BUDGET REACH SAMPLE",
    "stars.s4.story": "{starName} 是未被占用样本里更适合做低预算曝光参照的项目：预算 {starBudget} USDC、CPM {starCpm}、曝光 {starImp}。这个位置会随后台数据自动重算。",
  ...
  en: {
    ...
    "win.compare.eyebrow": "TOP KOL CPM / CPE BENCHMARK",
    "win.compare.title_a": "Put Lighthouse costs beside",
    "win.compare.title_b": "top-KOL benchmarks.",
    "win.compare.desc": "Internal samples show which playbook is more efficient, but not whether the price is high or low in the wider market. This comparison rail reserves space for external top-KOL CPM / CPE references, so real quotes can later make the cost gap visible.",
    "win.compare.status": "top-KOL reference data",
    "win.compare.best": "Lighthouse best",
    "win.compare.best_note": "lowest CPM in current baseline pool",
    "win.compare.avg": "Lighthouse weighted avg",
    "win.compare.avg_name": "{baselineCount} baseline samples",
    "win.compare.avg_note": "current baseline average",
    "win.compare.lh_cpm": "Lighthouse CPM",
    "win.compare.lh_cpe": "Lighthouse CPE",
    "win.compare.kol_cpm": "Top KOL CPM",
    "win.compare.kol_cpe": "Top KOL CPE",
    "win.compare.lighthouse_note": "weighted from {baselineCount} baseline samples",
    "win.compare.lighthouse_base": "Lighthouse baseline",
    "win.compare.placeholder_short": "top-KOL reference data",
    "win.compare.placeholder": "external top-KOL CPM / CPE reference",
    "win.compare.vs": "vs Lighthouse best",
    "win.compare.multiple": "{multiple}x vs Lighthouse best",
    "win.compare.metric_cpm": "CPM",
    "win.compare.metric_cpe": "CPE",
    "win.compare.kol1.label": "Top KOL sample 01",
    "win.compare.kol1.name": "Top Chinese KOL (TBD)",
    "win.compare.kol2.label": "Top KOL sample 02",
    "win.compare.kol2.name": "Top English KOL (TBD)",
    "win.compare.kol3.label": "Top KOL sample 03",
    "win.compare.kol3.name": "Vertical KOL (TBD)",
    ...
    "stars.sample": "SAMPLE",
    "stars.s1.tag": "Efficiency Sample", "stars.s1.en": "BEST OVERALL · COST × ENGAGEMENT",
    "stars.s1.story": "{starName} currently carries the strongest overall efficiency among projects not already selected for another sample: {starBudget} USDC budget, {starImp} impressions, and {starCpe} CPE.",
    ...
    "stars.s2.story": "{starName} is the highest-reach baseline sample right now, delivering {starImp} impressions. This slot claims the largest reach project first so it cannot also occupy another playbook slot.",
    "stars.s2.take": "When the goal is market visibility first, the largest reach sample gives a direct reference for budget, KOL tiering, and content density.",
    "stars.s3.tag": "Deepest Conversation", "stars.s3.en": "DEEPEST AI-NATIVE DIALOGUE",
    "stars.s3.story": "{starName} has the highest engagement rate among the remaining samples at {starEr}%. This slot represents discussion depth: content, audience, and topic design actually connecting.",
    ...
    "stars.s4.tag": "Low-Budget Reach", "stars.s4.en": "LOW-BUDGET REACH SAMPLE",
    "stars.s4.story": "{starName} is the best low-budget reach reference among projects not already selected: {starBudget} USDC budget, {starCpm} CPM, and {starImp} impressions. This slot recalculates with CMS data.",
    ...
    "matrix.outlier_k": "",
    "matrix.outlier_d": "",
    "tag.cpm_king": "Low-Budget Reach",
    "tag.value_king": "Efficiency",
    "tag.reach_king": "Top Reach",
    "tag.eng_king": "Deep Conversation",
    "tag.eng_2": "High ER",
