...
const DICT = {
  zh: {
    ...
    "win.compare.eyebrow": "EXTERNAL CPM BENCHMARK",
    "win.compare.title_a": "把灯塔 CPM 放进",
    "win.compare.title_b": "大 KOL 参照系。",
    "win.compare.desc": "内部样本只能说明谁更高效，但不能说明价格到底贵不贵。这里预留外部大 KOL CPM 对照，后续填入真实报价后，用户就能直接看到灯塔投放和单点大号投放的成本差异。",
    ...
    "win.compare.placeholder": "外部大 KOL CPM 占位",
    "win.compare.vs": "相对灯塔最低",
    "win.compare.kol1.label": "大 KOL 例 01",
    "win.compare.kol1.name": "头部中文 KOL（待填）",
    "win.compare.kol2.label": "大 KOL 例 02",
    "win.compare.kol2.name": "头部英文 KOL（待填）",
    "win.compare.kol3.label": "大 KOL 例 03",
  ...
  en: {
    ...
    "win.compare.title_b": "large-KOL pricing.",
    "win.compare.desc": "Internal samples show which playbook is more efficient, but not whether the price is high or low in the wider market. This comparison rail reserves space for large-KOL CPM references, so real quotes can later make the cost gap visible.",
    ...
    "win.compare.placeholder": "external large-KOL CPM placeholder",
    "win.compare.vs": "vs Lighthouse best",
    "win.compare.kol1.label": "Large KOL sample 01",
    "win.compare.kol1.name": "Top Chinese KOL (TBD)",
    "win.compare.kol2.label": "Large KOL sample 02",
    "win.compare.kol2.name": "Top English KOL (TBD)",
    "win.compare.kol3.label": "Large KOL sample 03",
