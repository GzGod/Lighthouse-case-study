...
const DICT = {
  zh: {
    ...
    "win.compare.title_b": "行业参照系。",
    "win.compare.desc": "内部样本只能说明谁更高效，但不能说明价格到底贵不贵。这里预留外部行业 CPM 对照，后续填入真实报价后，用户就能直接看到灯塔投放和单点大号投放的成本差异。",
    ...
    "win.compare.placeholder": "外部行业 CPM 占位",
  ...
  en: {
    ...
    "win.compare.title_b": "industry benchmarks.",
    "win.compare.desc": "Internal samples show which playbook is more efficient, but not whether the price is high or low in the wider market. This comparison rail reserves space for external industry CPM references, so real quotes can later make the cost gap visible.",
    ...
    "win.compare.placeholder": "external industry CPM placeholder",
