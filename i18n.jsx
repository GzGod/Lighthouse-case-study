...
const DICT = {
  zh: {
    ...
    "hero.stats_tl": "16 个项目 · 371 条推文 · Q4·25 — Q2·26",
    ...
    "hero.h1_c": "长期增长交付。",
    "hero.sub": ["基于 ", "16 个真实项目", "、", "371 条推文", "、", "超 300 万次曝光", "的投放记录，这份 Case Study 展示灯塔如何帮助项目方更早对齐预算、效率预期和交付边界，让每一次合作都能为下一次增长决策提供参照。"],
    "hero.stat1.k": "总预算池",
    "hero.stat1.u": "USDC · 全部链上结算",
    "hero.stat2.k": "总曝光量",
    "hero.stat2.u": "15 个基准项目 · 356 条推文",
    "hero.stat3.k": "峰值互动率",
    "hero.stat3.u": "由 HeyElsa 创造 · 行业均值 ≈ 0.4%",
    "hero.cta1": "查看完整案例 ↓",
    "hero.cta2": "聊聊你的项目",
    "hero.foot": "16 个项目样本 · 可回看数据 · 可对照基准",
    ...
    "about.f2": "◇ 累计服务项目 40+（本报告取样 16 个 · 15 个进入基准）",
    "about.f3": "◇ 结算货币 USDC · on Base",

    "kpi.kicker": "§ 03 · 长期合作要看的基准",
    "kpi.h2_a": "这些数字的价值，",
    "kpi.h2_b": "在于让后续判断更稳。",
    "kpi.p": "以下 6 个 KPI 来自 16 个项目的完整投放记录，保留真实波动，不做样本美化。它们让团队在下一次讨论预算、效率和目标时，有一套可以直接对照的参考线。",
    "kpi.k1": "总预算", "kpi.k1u": "USDC", "kpi.k1n": "15 个基准项目共同形成的预算参考",
    ...
    "kpi.k5": "最低 CPM", "kpi.k5u": "USDC", "kpi.k5n": "HashKey Exchange 跑出的高效曝光样本",
    "kpi.k6": "峰值互动率", "kpi.k6u": "ENGAGEMENT RATE", "kpi.k6n": "HeyElsa 把深度参与拉到行业均值上方",
    "kpi.sub1.k": "副指标 · 最低 CPE", "kpi.sub1.u": "USDC / 互动", "kpi.sub1.who": "Portals 把互动成本压到很低的区间",
    "kpi.sub2.k": "副指标 · 最大单场曝光", "kpi.sub2.u": "IMPRESSIONS", "kpi.sub2.who": "zkVerify 证明中高预算也能跑出规模",
    ...
    "matrix.scatter_note": "§ 散点图展示 15 个可进入常规对照的项目",
    ...
    "matrix.table.title": "完整数据表 · 16 个项目",
    ...
    "why.w2.t": "预算有参照", "why.w2.d": "15 个基准项目和 356 条推文沉淀出一条可对照的参考线，后续做预算讨论时更容易落到具体区间。",
    ...
    "footer.stats": "16 个项目 · 371 条推文 · 总曝光 3,023,117 · 可作为后续合作参照",
  ...
  en: {
    ...
    "hero.kicker_tl": "CASE STUDY · VOL. 01 / 2026",
    "hero.stats_tl": "16 PROJECTS · 371 TWEETS · Q4·25 — Q2·26",
    ...
    "hero.sub": ["Built on ", "16 real projects", ", ", "371 tweets", ", and ", "more than 3M impressions", ", this case study shows how Lighthouse helps teams align budget, expected efficiency, and delivery scope earlier — so each campaign leaves behind something useful for the next growth decision."],
    "hero.stat1.k": "Budget Pool",
    "hero.stat1.u": "USDC · fully on-chain settled",
    "hero.stat2.k": "Impressions",
    "hero.stat2.u": "across 15 baseline projects · 356 tweets",
    "hero.stat3.k": "Peak ER",
    "hero.stat3.u": "set by HeyElsa · industry avg ≈ 0.4%",
    "hero.cta1": "Read the full case ↓",
    "hero.cta2": "Talk through your project",
    "hero.foot": "16 project samples · reviewable records · benchmarkable results",
    "hero.scroll": "SCROLL · 01/07",
    ...
    "about.f2": "◇ 40+ projects served (16 sampled here · 15 in baseline)",
    ...
    "kpi.p": "These 6 KPIs come from complete campaign records across 16 projects. The swings are left intact and the sample is not polished for appearance. What matters is that teams now have a reference line they can use when discussing budget, efficiency, and goals the next time around.",
    "kpi.k1": "Total Budget", "kpi.k1u": "USDC", "kpi.k1n": "A budget reference built from 15 baseline projects",
    ...
    "kpi.k5": "Lowest CPM", "kpi.k5u": "USDC", "kpi.k5n": "A reach-efficiency sample delivered by HashKey Exchange",
    "kpi.k6": "Peak Engagement Rate", "kpi.k6u": "ENGAGEMENT RATE", "kpi.k6n": "HeyElsa pushed depth of participation above common market levels",
    "kpi.sub1.k": "Secondary metric · Lowest CPE", "kpi.sub1.u": "USDC / ENGAGEMENT", "kpi.sub1.who": "Portals pushed interaction cost into a very efficient range",
    "kpi.sub2.k": "Secondary metric · Largest Single-Campaign Reach", "kpi.sub2.u": "IMPRESSIONS", "kpi.sub2.who": "zkVerify shows that mid-to-large budgets can still scale cleanly",
    ...
    "matrix.scatter_note": "§ Scatter shows 15 projects (CPM 10–100)",
    ...
    "matrix.table.title": "Full data table · 16 projects",
    ...
    "why.w2.t": "Budget references', \"why.w2.d\": '15 baseline projects and 356 tweets have built a reference line that makes it easier to land on specific ranges in future budget discussions.",
    ...
    "footer.stats": "16 projects · 371 tweets · 3,023,117 total impressions · USDC on Base",
...
window.i18n = { DICT, LangContext, LangProvider, useT };
