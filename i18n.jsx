...
const DICT = {
  zh: {
    ...
    "win.compare.status": "示例占位 · 待填真实数据",
    ...
    "win.compare.placeholder_short": "待填真实头部 KOL 数据",
    "win.compare.placeholder": "外部头部 KOL CPM / CPE 占位",
  ...
  en: {
    ...
    "win.compare.status": "placeholder samples · awaiting real data",
    ...
    "win.compare.placeholder_short": "awaiting real top-KOL data",
    "win.compare.placeholder": "external top-KOL CPM / CPE placeholder",
